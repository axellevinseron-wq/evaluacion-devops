...
* The original package name 'com.example.ms-envios' is invalid and this project uses 'com.example.ms_envios' instead.
...
```
$ docker run --rm -p 8080:8080 ms-envios:0.0.1-SNAPSHOT
```
