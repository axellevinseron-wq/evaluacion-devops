...
* The original package name 'com.example.ms-promociones' is invalid and this project uses 'com.example.ms_promociones' instead.
...
```
$ docker run --rm -p 8080:8080 ms-promociones:0.0.1-SNAPSHOT
```
